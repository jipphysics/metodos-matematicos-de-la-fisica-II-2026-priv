...
We say that a sequence $\{x_j\in X:j\in \NN\}$ {\em converges} to a value $x\in X$ if, for each $\epsilon>0$, there exists an $N\in \NN$ such that $|x_j-x|<\epsilon$ for every $j\geq N$.
It can be easily shown that, when it converges, the value $x$ is unique.

The convergence of the sequence is abbreviately denoted by $x_j\to x$ as $j\to \infty$.

\subsection{Cauchy sequence}

A sequence $\{x_j\in X:j\in \NN\}$ is a {\em Cauchy sequence} if, for every $\epsilon>0$, there exists an $N\in \NN$ such that $|x_j-x_i|<\epsilon$ for every $i,j\geq N$.
...
More formally, if $\{x_j\in X:j\in \NN\}$ is a Cauchy sequence, then there exists an $x\in X$ such that, for every $\epsilon>0$, there exists an $N\in \NN$ such that $|x_j-x|<\epsilon$ for every $j\geq N$.
...
\end{enumerate}
In particular, a {\em semidefinite norm} is a norm without property 3.
...
A function $f:V\to \RR$ is continuous at $v$ if, 
