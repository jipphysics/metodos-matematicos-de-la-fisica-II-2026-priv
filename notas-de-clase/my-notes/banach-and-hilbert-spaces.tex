...
When $X$ is a finite-dimensional metric space, a subset $K$ of $X$ is called {\em compact} if it is closed and bounded.

{\color{red} 
{\em Remark:}
The notion of compactness works differently in infinite-dimensional metric spaces.
