...
A semi-linear Partial Differential Equations (PDEs) is of the form
\begin{equation}
\label{eq:X1}
a^{ij}(x,u(x),(\nabla u)(x))
(
...
0
\end{equation}
where $x=(x^1,...,x^n)\in D$ and $u:D\ni x \to u(x)\in \RR$ is a solution.
Here $D$ is an $n$-dimensional manifold and $(\nabla u)(x)\in \RR^n$ is the tangent space of $D$ at $x$.
