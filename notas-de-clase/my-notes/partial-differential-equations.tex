...
$$
G:
\partial D\times \RR\times \RR^n \times \RR^{n^2} \times ... \times \RR^{n^k}
\ni
(x,v,p_1,p_2,...,p_k)
\to
G(x,v,p_1,p_2,...,p_k) \in \RR
$$
where $\partial D$ is the boundary of $D$, and a corresponding equation
$$
G(x,v,p_1,p_2,...,p_k) = 0.
$$
...
Namely, a given function $u:D\to \RR$ solves the PDE in the weak or distributional sense if the corresponding function $F_u:D\to \RR$ given by
$$
F_u(x):=F(x,u(x),(\nabla u)(x),...,(\nabla ... \nabla u)(x))
$$
