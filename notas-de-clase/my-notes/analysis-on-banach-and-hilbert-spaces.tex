...
Banach spaces guarantee that limits associated with norm convergence remain within the space. Hilbert spaces additionally provide a geometric structure based on orthogonality, allowing generalized Fourier expansions and orthogonal projections.
This part develops these ideas.
...
Let $(V,|\cdot|)$ be a normed vector space and let $(v_n)_{n\in\mathbb{N}}$ be a sequence in $V$.
...
A subset ${e_i}_{i\in I}\subseteq H$ is called orthonormal if
$$
