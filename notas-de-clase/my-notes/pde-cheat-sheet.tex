...
{\color{red}[TODO: Talk about the particular case in which the Green function can be written using the Wronksian.]}
% https://chatgpt.com/share/6a3d351f-5880-83e9-a584-2423016d11d0

\section{Fourier Methods}

Fourier methods are particularly useful on infinite or periodic domains.

\subsection{Fourier Series}

If $u(x)$ is periodic with period $L$,
...
are eigenfunctions of the derivative operator:
...
Thus constant-coefficient differential equations become algebraic equations for the Fourier coefficients $c_n$.

\subsection{Fourier Transform}

For problems on the infinite line,

$$
-\infty<x<\infty,
$$

the discrete Fourier series is replaced by the Fourier transform
...
The Fourier transform may be regarded as the continuum limit of the Fourier series as $L\to\infty$.
...
Conversely, multiplication by $x$ becomes differentiation in Fourier space:
...
Therefore constant-coefficient differential equations become algebraic equations in Fourier space, while variable-coefficient equations generally remain differential equations.

\vspace{0.5cm}
{\bf Typical Applications:}
\begin{itemize}
\item Heat equation on $\mathbb R$.
\item Wave equation on $\mathbb R$.
\item Poisson equation on $\mathbb R^n$.
\item Construction of Green functions.
\item Spectral analysis of translation-invariant operators.
\end{itemize}
