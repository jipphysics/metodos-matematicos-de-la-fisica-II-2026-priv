...
\author{Diego Dorado}
\email[]{diego.dorado@mi.unc.edu.ar}
...
Considere un paraboloide hiperb\'olico embebido en el espacio Euncl\'ideo tridimensional dado, en coordenadas cartesianas, por $z=x^2-y^2$.
...
En un desplazamiento infinitesimal por una superficie determinada por la restricci\'on $u=\mathrm{constante}$, se tiene que $du=0$ y, por ende, se obtiene la m\'etrica reducida de coordenadas
$$
h_{ss} = g_{ss} = 1+4s^2
$$
$$
